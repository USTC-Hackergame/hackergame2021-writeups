...
wget -nc https://static.taoky.moe/disk-3fCidtn9LJjBsJAU3gyIjg.zip -O /tmp/disk2.zip || :
if [ "$(filesha256 /tmp/disk2.zip)" != "0845239b2f2c09d4cc96bafb3e41d60ecc5a1c099d94aebd6d865426f28aa84a" ]; then
    echo "Wrong sha256"
    exit 255
fi
# sudo mkdir mountpoint/files/
sudo 7z x /tmp/disk2.zip '-pGBNgJH-65Eg28lbIVuR8NoXB_kAKGPsW3HuO-wUi0Dw' -o/tmp/files/
sudo mv /tmp/files/diskfiles-2/ ./mountpoint/files/
